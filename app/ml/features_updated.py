...
from app.constants import CATEGORY_LIST, OCCASION_LIST
...
# ⚠️ CATEGORY_LIST/OCCASION_LIST أنفسهما انتقلا إلى app/constants.py
# (مصدر وحيد يستورد منه هذا الملف و app/models.py معًا) — استُوردا أعلاه.
